...
func Builtin() Catalog {
	catalog := Catalog{Schema: 1, Name: "ExpOS Prism Forms", GeneratedAt: time.Date(2026, 9, 8, 0, 0, 0, 0, time.UTC), Packages: []Package{
		...
		{Name: "PrismDE", Version: "1.1.0", Summary: "Pointer-driven capability-native desktop environment", Capabilities: []string{"render", "input", "configure"}, ProvidedForms: []string{"PrismDesktop"}, Dependencies: []string{"HexaDisplay@>=1.0.0", "Terminal@>=1.2.0", "MouseKit@>=1.0.0", "SessionManager@>=1.0.0"}},
