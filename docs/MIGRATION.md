...
| `driver`, `net`, `fb` | device, RTL8139, framebuffer code | capability-gated Driver Forms | runtime 640x480/1280x720/1920x1080 Bochs/QEMU framebuffer, two-page VBE presentation with damage-region synchronization, bounded-retrace VSync, persistent 60/75/120/144 Hz compositor pacing and timing diagnostics landed; polling RTL8139 Ethernet, ARP, static IPv4, ICMP, UDP, DNS, one TCP client, HTTP/1.0 and bounded authenticated TLS 1.3 HTTPS landed; scoped DigiCert trust for DuckDuckGo search landed; DHCP, IPv6, physical Wi-Fi and physical monitor-mode negotiation queued |
