...
mod tests {
    ...
    fn parses_a_safe_local_document_and_links() {
        ...
        assert_eq!(document.title(), "Hexa Home");
    ...
    fn bounded_inputs_fail_without_overflowing_storage() {
        ...
        assert!(matches!(
            Document::parse("hexa://large", &oversized),
        ...
        assert!(matches!(
            Document::parse("hexa://capacity", &source),
    ...
    fn script_and_stylesheet_limits_are_enforced_and_reported() {
        let mut document =
            Document::parse("hexa://limits", "<title id='title'>Limits</title>").unwrap();
        ...
        let mut fresh = Document::parse("hexa://script-limit", "<title>Limits</title>").unwrap();
        ...
        assert!(matches!(
            Document::parse("hexa://style-limit", &css),
